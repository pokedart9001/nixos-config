   ...
   <div align="center">
      ...
      <div align="center">
         <a = href="https://nixos.org">
            <img src="https://img.shields.io/badge/NixOS-24.05-blue?style=for-the-badge&logo=NixOS&logoColor=white&labelColor=303446&color=91D7E3">
         </a>
...
| **Lockscreen**              | [i3lock-color][i3lock-color] |
| **Image Viewer**            | [imv][imv] |
| **Media Player**            | [mpv][mpv] |
| **Screenshot Software**     | [escrotum][escrotum] |
| **Color Picker**            | [xcolor][xcolor] |
...
- ```nix-edit```         $\rightarrow$ ```codium ~/nixos-config```
